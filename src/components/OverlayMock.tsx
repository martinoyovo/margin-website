    ...
    <div className="relative mx-auto w-full max-w-3xl">
      ...
      <div className="relative overflow-hidden rounded-2xl border border-line bg-card shadow-[0_8px_40px_-12px_rgba(0,0,0,0.25)]">
        ...
        <div className="relative flex min-h-[300px]">
          ...
          <div className="animate-slide-edge absolute inset-y-3 right-3 flex w-[58%] flex-col rounded-xl border border-line-2 bg-surface-2 p-4 backdrop-blur-md sm:w-[52%]">
            ...
            {/* user question */}
            <div className="mt-3 self-end rounded-2xl rounded-br-sm bg-surface-2 px-3 py-2 text-[12px] text-paper">
              What did I decide here?
            </div>

            {/* answer, pulled from the note */}
            <div className="mt-3 flex gap-2">
              <span className="animate-core mt-0.5 shrink-0 text-[12px] leading-none text-accent">
                ✦
              </span>
              <div>
                ...
                <p className="mt-1.5 font-mono text-[9px] text-accent/80">
                  From this note · Mar 3
                </p>
              </div>
            </div>

            <div className="mt-auto flex items-center gap-2 rounded-full border border-line-2 bg-surface-2 px-3 py-2">
